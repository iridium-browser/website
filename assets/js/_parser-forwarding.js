...
else if (os_name == "SUSE") { window.location="/downloads/linux/#suse"; }
else if (os_name == "CentOS") { window.location="/downloads/linux/"; }
else if (os_name == "Fedora") { window.location="/downloads/linux/#fedora"; }
...
else if (os_name == "RedHat") { window.location="/downloads/linux/#redhat"; }
